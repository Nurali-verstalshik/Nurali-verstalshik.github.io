...
(function( $, window, document, undefined ) {
	...
	var Carousel = {
		...
		buildButtons : function(){
			var base = this;
			var buttonsWrapper = $("<div class=\"owl-buttons slid\"/>")
			base.owlControlls.append(buttonsWrapper)

			base.buttonPrev = $("<div/>",{
				"class" : "owl-prev arrow arrowLeft ant-carousel-arrow-left",
				"text" : base.options.navigationText[0] || ""
				});

			base.buttonNext = $("<div/>",{
				"class" : "owl-next arrow arrowRight ant-carousel-arrow-right",
